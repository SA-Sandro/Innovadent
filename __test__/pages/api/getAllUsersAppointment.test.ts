...
import handler from "../../../pages/api/getAllUsersAppointment";
...
describe("GET /api/getAllUsersAppointment handler", () => {
  it("should return 200 when method is GET", async () => {
    const req = { method: "GET" } as NextApiRequest;
    const res = createMockResponse();

    (getAllUsersAppointment as Mock).mockResolvedValue(mockData);
