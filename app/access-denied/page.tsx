...
export default function AccessDenied() {
    ...
    return (
        <div className="relative bg-white/90 mx-3 md:mx-5 p-5 md:p-10 rounded-xl flex flex-col justify-center items-center max-w-xl">
            ...
            <Link href={'/home'} type="button" className="mt-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                Volver
            </Link>
